...
namespace MyCampusV2.DAL.IRepositories
{
    public interface IReportRepository
    {
        ...
        IQueryable<TimeAttendanceVisitorEntity> GetAllTimeAttendanceVisitor(timeAttendanceVisitorFilter filter);
        IQueryable<AlarmEntity> GetAllAlarmStudent(alarmFilter filter);
        IQueryable<AlarmEmployeeEntity> GetAllAlarmEmployee(alarmEmployeeFilter emp);
        ...
        IQueryable<AlarmVisitorEntity> GetAllAlarmVisitor(alarmVisitorFilter filter);
        IQueryable<formEntity> GetAllForms();
        IQueryable<CardEntity> GetAllCardReport(cardFilterVM filter);

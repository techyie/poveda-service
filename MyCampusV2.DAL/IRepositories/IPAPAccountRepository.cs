...
{
    public interface IPAPAccountRepository : IBaseRepository<papAccountEntity>
    {
        Task<String> AddMobileAppAccount(papAccountEntity papAccount, int userId);
        ...
        Task<ResultModel> RequestChangePassword(string accountCode, int userId);
        Task<papAccountEntity> ValidateChangePasswordLink(string accountCode);
